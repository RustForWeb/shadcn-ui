...
use crate::schema::{Registry, RegistryEntry, RegistryItemCssVars, RegistryItemType};

pub static THEMES: LazyLock<Registry> = LazyLock::new(|| {
    vec![
        RegistryEntry {
