...
mod tests {
    ...
    #[test]
    fn test_textarea_component_with_props() {
    ...
    #[test]
    fn test_textarea_component_with_children() {
        let result = LeptosTestUtils::test_component_renders();
        assert!(result.passed);
    }

    #[test]
    fn test_textarea_component_styling() {
        let result = LeptosTestUtils::test_component_styling();
        assert!(result.passed);
    }

    #[test]
    fn test_textarea_component_accessibility() {
