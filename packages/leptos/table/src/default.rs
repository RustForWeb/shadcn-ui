...
pub fn TableHead(
    ...
    view! {
        <th
            ...
            class=move || tw_merge!("h-12 px-4 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0", class.get())
            id=move || id.get()
            style=style
...
pub fn TableCell(
    ...
    view! {
        <td
            ...
            class=move || tw_merge!("p-4 align-middle [&:has([role=checkbox])]:pr-0", class.get())
            id=move || id.get()
            style=style
